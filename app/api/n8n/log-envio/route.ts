...
/**
 * API para n8n - Registra mensajes enviados por WhatsApp
 *
 * POST /api/n8n/log-envio
 *
 * Body JSON:
 * {
 *   "socio_id": "123",        // obligatorio
 *   "telefono": "5411...",    // opcional
 *   "mensaje": "Hola...",     // obligatorio
 *   "estado_envio": "enviado",// opcional, default 'enviado'
 *   "canal": "whatsapp",      // opcional, default 'whatsapp'
 *   "workflow_id": "xxx",     // opcional, default 'cobranzas_n8n'
 *   "respuesta_api": "{...}"  // opcional, respuesta de WhatsApp API
 * }
 */
